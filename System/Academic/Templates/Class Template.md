...
> **Note:** After clicking a button, the Smart Template will:
> 1. Auto-detect this class from your recent files
> 2. Offer to add the course code to the filename
> 3. Auto-fill the class property
...
action:
  ...
  templateFile: "Templates/Coursework Template (Smart).md"
  folder: ""
