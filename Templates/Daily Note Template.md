...
```datacorejsx
const script = await dc.require(dc.fileLink("System/Scripts/dc-sleep-tracker.jsx"));
...
const css = await app.vault.adapter.read("System/Scripts/dc-today-menu.css");
...
const script = await dc.require(dc.fileLink("System/Scripts/dc-today-menu.jsx"));
return function View() { return script.Func(); }
```

```datacorejsx
const script = await dc.require(dc.fileLink("System/Scripts/dc-water-tracker.jsx"));
return function View() { return script.Func(); }
```
...
```datacorejsx
const script = await dc.require(dc.fileLink("System/Scripts/dc-workout-today.jsx"));
...
```datacorejsx
const script = await dc.require(dc.fileLink("System/Scripts/dc-journal-nav.jsx"));
return function View() { return script.Func(); }
```
...
```datacorejsx
const script = await dc.require(dc.fileLink("System/Scripts/dc-mood-tracker.jsx"));
return function View() { return script.Func(); }
```
...
```datacorejsx
const script = await dc.require(dc.fileLink("System/Scripts/dc-routine-tracker.jsx"));
return function View() { return script.Func(); }
```
